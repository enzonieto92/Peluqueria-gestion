...
namespace CustomControls.RJControls
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Peluquería.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Peluquería.Properties.Resources.calendarDark;
                else calendarIcon = Peluquería.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
